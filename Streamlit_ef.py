...
end_date = st.sidebar.date_input("End date:", value=pd.Timestamp("2025-02-01"))
...
max_weight = st.sidebar.number_input(
    "Maximum weight per stock (0 = no constraint):", min_value=0.0, max_value=1.0, value=0.40
)
if max_weight == 0:
...
investment_amount = st.sidebar.number_input(
    "Enter your available investment amount (€):", min_value=0.0, value=40000.0
)
